...
public class MagmaBucket extends BucketItem {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(simpChemTooltip("bucket", Text.translatable("temperature.simpchemlib.magma_bucket").formatted(Formatting.RED)).formatted(Formatting.RESET, Formatting.GRAY));
    }
}
