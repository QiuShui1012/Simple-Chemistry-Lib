...
public class TristateConverterScreen extends HandledScreen<TristateConverterScreenHandler> {
    private static final Identifier TEXTURE = new Identifier(SimpChemLib.MOD_ID,"textures/gui/element_extractor_gui.png");
    public TristateConverterScreen(TristateConverterScreenHandler handler, PlayerInventory inventory, Text title) {
