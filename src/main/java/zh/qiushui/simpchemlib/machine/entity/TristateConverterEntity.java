...
import static zh.qiushui.simpchemlib.registry.MachineRegistry.TRISTATE_CONVERTER_ENTITY;

public class TristateConverterEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public TristateConverterEntity(BlockPos pos, BlockState state) {
        super(TRISTATE_CONVERTER_ENTITY, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index){
                    case 0 -> TristateConverterEntity.this.progress;
                    case 1 -> TristateConverterEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index){
                    case 0 -> TristateConverterEntity.this.progress = value;
                    case 1 -> TristateConverterEntity.this.maxProgress = value;
                }
            }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new TristateConverterScreenHandler(syncId,playerInventory,this,this.propertyDelegate);
    }
